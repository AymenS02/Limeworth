  ...
  return (
    <Reveal>
      <div className="font-josefin flex justify-center items-center gap-[10vh] pb-[30vh] text-white">
        <div className="p-[3vh] bg-blue-800 rounded-lg border-2 border-white shadow-2xl">
        ...
        <div className="m-8 flex justify-center items-center border-2 border-white rounded-full w-[30vh] h-[30vh] overflow-hidden shadow-2xl">
