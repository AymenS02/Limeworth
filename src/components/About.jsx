...
function About() {
  return (
    <div className="font-josefin flex flex-col justify-center items-center pb-[30vh] text-white">
      <Reveal>
        <div
          className="flex flex-col justify-center items-center text-center p-8 bg-blue-800 rounded-lg shadow-lg xl:mx-[40vh] mx-[5vh] my-[5vh] border-2 border-white">
      ...
      <Reveal>
        <div className="flex flex-col justify-center items-center text-center p-8 bg-blue-800 rounded-lg shadow-lg xl:mx-[40vh] mx-[5vh] my-[5vh] border-2 border-white">
