...
function About() {
  return (
    <div className="font-josefin flex flex-col justify-center items-center pb-[30vh] text-white">
      <Reveal>
        <div
          className="flex flex-col justify-center items-center text-center m-10 p-8 bg-blue-800 rounded-lg shadow-lg w-[80vh]">
      ...
      <Reveal>
        <div className="flex flex-col justify-center items-center text-center p-8 bg-blue-800 rounded-lg shadow-lg w-[80vh]">
